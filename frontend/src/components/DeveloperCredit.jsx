...
const LYRICS = [
    '김새는 일이나 난관 속에서도 흔들림 없이 시작했던 우리',
    '동고동락하며 서로에게 힘이 되어준 시간들이 지나갑니다.',
    ...
    '',
    '윤곽이 잡히지 않던 막막한 시작점부터 마침표를 찍기까지',
    '가장 가까운 곳에서 서로를 믿고 지지해 주었기에',
    '연속되는 어려움 속에서도 우리는 결국 해낼 수 있었습니다.',
    '',
    '정성을 다해 한 걸음 한 걸음 함께 걸어와 준',
    '말로 다 표현하지 못할 만큼 고마운 우리 팀원분들',
    '',
    '고단했던 모든 과정이 우리를 더 성장시켰으리라 믿습니다.',
    '생각지도 못한 좋은 인연을 만나 함께 할 수 있어 행복했고',
